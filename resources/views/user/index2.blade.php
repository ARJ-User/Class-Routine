...
<body>
    ...
    <section class="slider-area">
        <div class="sliders owl-carousel">
            <div class="single-slider" style="background-image: url(/frontend-asstets2/assets/image/banner/banner2.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
            ...
            <div class="single-slider" style="background-image: url(/frontend-asstets2/assets/image/banner/banner3.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="top-slider-content">
